...
import { blogMetaMap, type BlogMeta } from "./blogMeta";

export const dynamic = "force-static";

type BlogListItem = { slug: string; meta: BlogMeta };

function getAllPosts(): BlogListItem[] {
  return Object.entries(blogMetaMap)
                ...
                {posts[0].meta.image && (
                  <div className="relative aspect-[16/9] md:aspect-auto md:w-[52%] overflow-hidden flex-shrink-0 bg-gray-100">
                    <Image
                      ...
                      priority
                      unoptimized={posts[0].meta.image.startsWith("http")}
                    />
                  </div>
                )}
